export const translations = {
  es: {
    // WelcomeView
    welcomeTitle: "¡Hola!",
    welcomeSubtitle: "Antes de empezar, personaliza tu perfil local.",
    ...
    of: "de",
    allDone: "¡Todo listo!",
    doneNextStep: "Hecho — siguiente paso",
  ...
  en: {
    welcomeTitle: "Hello!",
    welcomeSubtitle: "Before we start, customize your local profile.",
    ...
    mockSteps: [
      ...
      "Continue for just 5 minutes. If you want to stop after that, you can.",
      "Write down on a piece of paper what your next step will be when you return to it.",
      "Take a break, drink some water, and reward yourself for making progress."
    ]
  },
  ca: {
    welcomeTitle: "Hola!",
    welcomeSubtitle: "Abans de començar, personalitza el teu perfil local.",
    chooseLanguage: "Idioma / Llengua",
    chooseAvatar: "Tria el teu avatar",
    ...
    errorTitle: "Ui, alguna cosa ha fallat",
    ...
    mockSteps: [
      ...
      "Continua durant només 5 minuts. Si després vols parar, pots fer-ho.",
      "Anota en un paper quin serà el teu següent pas quan hi tornis.",
      "Pren-te un respir, beu aigua i premia't per haver avançat."
    ]
  }
};
